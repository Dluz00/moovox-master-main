...
const vaccineService = {
  //Service para listar todas vacinas
  ...
  // Service para listar uma vacina especifica
  ...
  //Service para atualizar uma vacina
  ...
  //Service para deletar uma vacina
