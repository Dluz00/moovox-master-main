...
const userService = {
  ...
  async changePassword(id, newPassword) {
    ...
    // Atualizar a senha manualmente via email (útil para reset ou admin)
    async updatePasswordManual(email, novaSenha) {
      try {
        ...
        console.error(`Erro ao atualizar senha manualmente no service: ${error}`);
        throw new Error("Erro ao atualizar senha manualmente (service): " + error.message);
      }
    },
